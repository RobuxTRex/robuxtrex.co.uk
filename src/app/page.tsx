...
export default function Home() {
  ...
  return (
    <main className="scrollbar-thin scrollbar-track-blue-300 overflow-y-scroll">
      <Header></Header>
      <div className="">
        <div className="text-left pl-48 pt-24 text-zinc-400 text-xl">
          <h1 className="text-8xl font-black text-white">{word || "Hello!"}</h1>
          <h2 className="text-3xl text-zinc-200 font-semibold pt-2">I am RobuxTRex.</h2>
